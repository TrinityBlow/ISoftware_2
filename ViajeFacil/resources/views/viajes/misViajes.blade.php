                ...
                @foreach ($mis_viajes->reverse() as $viaje)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="text-center" href="/viajes/modificarViaje/{{ $viaje -> id_grupo }}"> <button type="button" class="btn btn-primary btn-sm mt-2">Modificar</button></a>
                            <button class="btn btn-danger btn-sm mt-2" data-id="{{ $viaje -> id_grupo }}" data-toggle="modal" data-target="#eliminarModal">Eliminar</button></a>
                        </td>
                    </tr>
                @endforeach
            </table>
